...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
			...
			b = a.extend(c, b), this.each(function () {
				function c() {
					...
					b.constrain_width === !0 && f.css("width", e.outerWidth()), f.css(d(e[0]) ? {
						...
						position: "fixed",
						height: 0,
						top: e.offset().top - a(window).scrollTop(),
						left: e.offset().left
					} : {
						display: "block",
						top: e.offset().top,
	...
	function (a) {
		...
		}, a.Waves = h, $(document).ready(function () {
			h.displayEffect()
		})
	}(window),
	function (a) {
		a.fn.sideNav = function (b) {
			...
			b = a.extend(c, b), a(this).each(function () {
				function c() {
					g = !1, h = !1, a("#sidenav-overlay").animate({
						opacity: 0
					}, {
						duration: 200,
						queue: !1,
				...
				"left" != b.edge && e.addClass("right-aligned"), a("body").append(a('<div class="drag-target"></div>')), a(".drag-target").css("left" === b.edge ? {
					...
					a(window).width() > 1200 && e.attr("style") && e.removeAttr("style")
				});
				var g = !1,
					h = !1;
				a(".drag-target").hammer({
					...
					h && !g && a("#sidenav-overlay").trigger("click")
				}).bind("pan", function (d) {
	...
	function (a) {
		a(document).ready(function () {
			var b = "input[type=text], input[type=password], input[type=email], input[type=tel], input[type=number], textarea";
